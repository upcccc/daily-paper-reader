...
method: 提出GT-PD算法，结合了自我中心投影剪裁和基于双指标信任评分的概率边缘丢弃机制，并针对持续扰动引入了漏积分改进版。
result: "理论上证明了算法在不同隔离场景下的线性收敛性，实验中在MNIST数据集上比坐标修剪均值法准确率提升高达4.3%。"
conclusion: 通过结合概率丢弃与投影技术，该研究为去中心化网络提供了具备强鲁棒性和收敛保障的梯度追踪新方案。
---
